...
public class FileOperations 
{
	public static void createdFileXRound(String pPlayer_name, int pPoints_round, long pTime_round) 
	{
		try {
			...
			PrintWriter basic_player = new PrintWriter(new FileWriter("D:\\xllEs\\Documents\\2020 - IISem\\Análisis de Algoritmos\\Backtraking\\Qwirkle-Game-Analysis-BackTracking-JAVA-CR-2020\\turnos.txt", true), true);
